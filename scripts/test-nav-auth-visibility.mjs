...
assert.match(header, /src=\{`\$\{base\}brand\/kainnne-wordmark\.png`\}/);
assert.match(header, /class="brand-logo"/);
assert.match(header, /alt="Kainnne"/);
assert.doesNotMatch(header, /brandHomeLabel|brand-home|brand-sigil|id="brand-label"|data-i18n="nav\.homeLabel"/);
...
assert.match(header, /id="brand-link"[\s\S]*?href=\{base\}/);
