...
- 以 Email 驗證解鎖 **Kainnne x Gemini**，由 AI 助理依公開資料介紹 Kaine 的專長、工作方式與可協助的方向。
- 前 5 則訊息後會詢問是否續聊；訪客確認後，系統寄一封不含對話內容的通知信給 Kaine，再繼續使用。每日 token 總上限仍保留；無關的一般問答不呼叫 Gemini。
